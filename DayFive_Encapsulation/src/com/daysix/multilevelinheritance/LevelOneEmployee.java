...
public class LevelOneEmployee extends Employee {
	...
	public LevelOneEmployee(String name, long contactNo, String deptName, double baseSalary, int noOfShares, String authority) {
	...
	public String toString() {
		return "LevelOneEmployee [noOfShares=" + noOfShares + ", authority=" + authority + ", getDeptName()="
				...
				+ ", getName()=" + getName() + ", getContactNo()=" + getContactNo() + "]";
	}
